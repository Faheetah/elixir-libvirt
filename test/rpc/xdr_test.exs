defmodule Libvirt.RPC.XDRTest do
  ...
  describe "decoding" do
    ...
    test "hyper" do
      ...
      assert XDR.decode(<<255, 255, 255, 255, 255, 255, 255, 255>>, spec) == %{
               "hyper" => 18_446_744_073_709_551_615
             }
    end
  ...
  describe "decoding real world payloads" do
    test "decoding a list of networks" do
      ...
      payload = <<
        ...
        103,
        101,
        # uuid: 179e0d3e-8a07-4852-be42-a7a34b85c9dc
        0,
        23,
        158,
        13,
      ...
      expected = %{
        "nets" => [%{"name" => "host-bridge", "uuid" => "179e0d3e-8a07-4852-be42-a7a34b85c9dc"}],
        "ret" => 1
      }
